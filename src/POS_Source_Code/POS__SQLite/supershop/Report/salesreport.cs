...
namespace supershop
{
    public partial class salesreport : Form
    {
            ...
            else
            {
                ...
                { 
                    string sql = "select  sales_id as 'Receipt No' , sales_time as Date, item_id as 'Item ID', itemName as 'Item Name' , " +
                                 ...
                                 " from sales_item where  itemName   like  '" + txtItemSearchBox.Text + "%' " + 
                                 " or sales_id   =  '" + txtItemSearchBox.Text + "' " +
        ...
        private void dtSalesItemStart_TextChanged(object sender, EventArgs e)    //Monthly / Yearly 
        {
        ...
        //Sales Payment Report Date to date  with retun item
        private void dtEndDate_ValueChanged(object sender, EventArgs e)  ///////Search From
        {
            if (dtEndDate.Text == "")
            {
        ...
        private void dateTimePicker6Return_ValueChanged(object sender, EventArgs e)  
        {
            ...
            else
            {
                try
                {
                    ...
                    DataRow repdt = dt1.NewRow();
                    repdt[0] = "From : " + dtReturnStartDate.Text;
                    repdt[1] = "To : " + dtReturnEndDate.Text;
                    dt1.Rows.Add(repdt);
