...
namespace supershop
{
    public partial class Home : Form
    {
        ...
        private void salesRegisterV2ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            SalesRegisterV2 go = new SalesRegisterV2();
            go.MdiParent = this;
            go.Show();
        }
        ...
        private void giftCardToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Customer.GenerateGiftCard go = new Customer.GenerateGiftCard();
            go.MdiParent = this;
            go.Show();
        }

        private void usedGiftCardRecordsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Customer.Consumedgiftcardlist go = new Customer.Consumedgiftcardlist();
            go.MdiParent = this;
            go.Show();
        }
