...
namespace supershop
{
	...
	static string _ConnectionString = "Server=34.228.63.108;Database=APOSDB;Trusted_Connection=False;User ID=sa;Password=830434Jr.;MultipleActiveResultSets=True";
