...
namespace supershop
{
    public partial class Payment : Form
    {
        ...
        {
            DialogResult result = MessageBox.Show("Do you want to Complete this transaction?", "Sí o no", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2);
